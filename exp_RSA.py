...
def main():
    ...
    # Only take models that contain '0.0dropout'
    cand = [p for p in all_folders if "0.0dropout" in os.path.basename(p)]
    ...
    if not model_folders:
        raise SystemExit(f"No matching model folders (containing '0.0dropout') under: {models_root}")
